...
class Warehouse(RoomCalculator):
    """Warehouse room calculator."""
    ...
    def defaults() -> RoomSpec:
        ...
        return RoomSpec(
            ...
            occupants=10,
            phase="general",
            floor_area_m2=100.0,  # TODO update
            height_m=2.6,  # TODO update
        )
    ...
    def compute(spec: RoomSpec) -> RoomReport:
        ...
        # --- 1) Lookup rates ---------------------------------------------------
        # TODO: adjust the table key ("warehouse") and activity
        ...
        report = (
            ReportBuilder(Warehouse.TYPE_ID, spec.name)
            .geom(

...
class RoomCalculator:
    ...
    def defaults() -> RoomSpec:
        ...
        raise NotImplementedError("RoomCalculator.defaults must be implemented by subclasses")

    @staticmethod
    def compute(spec: RoomSpec) -> RoomReport:
        """Perform internal computations and return RoomReport (subclasses must override)."""

        raise NotImplementedError("RoomCalculator.compute must be implemented by subclasses")